...
namespace ModelServices.Interfaces.EntitiesServices
{
    ...
    {
        Int32 Create(CATEGORIA_AGENDA item, LOG log);
        Int32 Create(CATEGORIA_AGENDA item);
        Int32 Edit(CATEGORIA_AGENDA item, LOG log);
        Int32 Edit(CATEGORIA_AGENDA item);
        Int32 Delete(CATEGORIA_AGENDA item, LOG log);
