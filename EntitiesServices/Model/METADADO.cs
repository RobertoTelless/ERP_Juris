...
namespace EntitiesServices.Model
{
    ...
    public partial class METADADO
    {
        ...
        public string META_SG_SIMBOLO { get; set; }
        public string META_DS_DESCRICAO { get; set; }
        public Nullable<int> TIMD_CD_ID { get; set; }
        public Nullable<int> META_IN_TAMANHO { get; set; }
        public Nullable<int> META_IN_OBRIGATORIO { get; set; }
        public Nullable<int> META_IN_INDEXADO { get; set; }
