    ...
    public class AdministracaoController : Controller
    {
        ...
        public ActionResult FiltrarUsuario(USUARIO item)
        {
            try
            {
                ...
                Int32 volta = baseApp.ExecuteFilter(item.CAUS_CD_ID, item.CARG_CD_ID, item.USUA_NM_NOME, item.USUA_NM_LOGIN, item.USUA_NM_EMAIL, item.USUA_NR_CPF, idAss, out listaObj);
        ...
        public ActionResult IncluirUsuario(UsuarioViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (volta == 1)
                    {
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0012", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 2)
                    {
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0013", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 3)
                    {
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0022", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 4 )
                    {
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0023", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 5)
                    {
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0027", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 6)
                    {
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0028", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 7)
                    {
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0029", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
