...
namespace ERP_Juris.Controllers
{
    public class BancoController : Controller
    {
        ...
        public BancoController(IBancoAppService baseApps, ILogAppService logApps, IContaBancariaAppService contaApps, IUsuarioAppService usuApps, ITipoContaAppService tcApps)
        {
            baseApp = baseApps;
            logApp = logApps;
            contaApp = contaApps;
        ...
        public ActionResult MontarTelaBanco()
        {
            ...
            {
                ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0046", CultureInfo.CurrentCulture));
            }
        ...
        public ActionResult IncluirBanco(BancoViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        Session["MensBanco"] = 3;
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0047", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
        ...
        public ActionResult EditarBanco(Int32 id)
        {
            ...
            {
                ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0049", CultureInfo.CurrentCulture));
            }
        ...
        public ActionResult IncluirConta(ContaBancariaViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        Session["MensBanco"] = 5;
                        ModelState.AddModelError("", ERPJuris_Resource.ResourceManager.GetString("M0048", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
