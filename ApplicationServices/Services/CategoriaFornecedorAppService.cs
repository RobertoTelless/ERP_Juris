...
namespace ApplicationServices.Services
{
    public class CategoriaFornecedorAppService : AppServiceBase<CATEGORIA_FORNECEDOR>, ICategoriaFornecedorAppService
    {
        ...
        public CATEGORIA_FORNECEDOR CheckExist(CATEGORIA_FORNECEDOR ag, Int32 idAss)
        {
            CATEGORIA_FORNECEDOR item = _baseService.CheckExist(ag, idAss);
            return item;
        }
        ...
        public Int32 ValidateEdit(CATEGORIA_FORNECEDOR item, CATEGORIA_FORNECEDOR itemAntes)
        {
            try
            {
                // Persiste
        ...
        public Int32 ValidateDelete(CATEGORIA_FORNECEDOR item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    ASSI_CD_ID = usuario.ASSI_CD_ID,
                    LOG_IN_ATIVO = 1,
                    LOG_NM_OPERACAO = "DeleCAFO",
                    LOG_TX_REGISTRO = "Categoria de Fornecedor: " + item.CAFO_NM_NOME
                };
